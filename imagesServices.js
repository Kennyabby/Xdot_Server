 ...
 */
const upload = async (imageName, base64Image, type, userName, path) => {
  const params = {
    Bucket: `${BUCKET_NAME}/NapsiteFiles/${userName}/images/${path}`,
    Key: imageName,
...
const getObject = async (key, userName, path) => {
